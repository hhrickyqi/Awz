...
<%@ taglib prefix="wc" uri="http://ricky/utils/"%>
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
            function addProduct(){
                window.location.href = "${pageContext.request.contextPath}/categoryList.do";
            }
	...
	<body>
		...
		<form id="Form1" name="Form1"
			  action="${pageContext.request.contextPath}/adminSearch.do"
			  method="post">
							...
							<c:forEach items="${productList}" var="product" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
											href="${ pageContext.request.contextPath }/adminEditProduct.do?pid=${product.pid}">
										<img
