...
<div class="container-fluid">
	...
	<div class="col-md-3" style="padding-top:20px">
		<ol class="list-inline">
			...
			<li><a href="/order_list.do">我的订单</a></li>
		</ol>
	</div>
</div>
...
<div class="container-fluid">
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/productList.do">首页</a>
			</div>

			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li class="active"><a href="/productList.do">手机数码<span class="sr-only">(current)</span></a></li>
					<li><a href="#">电脑办公</a></li>
					<li><a href="#">家具家居</a></li>
					<li><a href="#">鞋靴箱包</a></li>
				</ul>
	...
	<script type="text/javascript">
        function searchWord(obj) {
            ...
            if(word != ""){
                $.ajax({
                    url:${pageContext.request.contextPath}"/searchWord.do",
                    type:"POST",
